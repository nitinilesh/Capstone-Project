...
Feature: Automate Place Order: Register Before Checkout

  Scenario Outline: User Successfully register before checkout
    Given User is on homePage of eCommerce site
    And User Click on Register/login button of navbar
    ...
    Examples: 
      ...
      | Nilesh Patel | Nilesh    | Patel    | nilesh43@gmail.com | nilesh123 |  15 | March | 2014 | ola     | tg road | kota     | India   | Rajasthan | jaipur |  700554 |    584579654 |
